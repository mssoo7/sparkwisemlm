<div>
	...
	<!-- main Wallet -->
	<div class="col-lg-4 col-md-4 col-heading bg-success card">
		<h3 style="font-weight: 600"><small>Current E-Wallet: </small>{{$e_wallet}}<sup style="font-size: 15px"> <i class="fa {{$global_currency}}"></i></sup></h3>
	</div>
			...
			<table class="table table-bordered">
			  <thead class="thead-dark ">
				<tr class="font-weight-bold">
				  ...
				  <th wire:click="sortBy('trans_type')">Type
